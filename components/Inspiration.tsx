            ...
            <div className="flex flex-wrap -m-4">
              <div className="xl:w-1/3 md:w-1/2 p-4">
                <div className="bg-gray-100 p-6 rounded-lg">
                  ...
                  <h3 className="tracking-widest text-indigo-500 text-xs font-medium title-font">Amstelveen</h3>
              ...
              <div className="xl:w-1/3 md:w-1/2 p-4">
                <div className="bg-gray-100 p-6 rounded-lg">
                  ...
                  <h3 className="tracking-widest text-indigo-500 text-xs font-medium title-font">Amsterdam</h3>
              ...
              <div className="xl:w-1/3 md:w-1/2 p-4">
                <div className="bg-gray-100 p-6 rounded-lg">
                  ...
                  <h3 className="tracking-widest text-indigo-500 text-xs font-medium title-font">Almelo</h3>
